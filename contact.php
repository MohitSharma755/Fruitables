    ...
    <div class=" container bg-light py-5 rounded mt-5 mb-5 col-xl-12">
        ...
        <form action="" class="px-3" method="post">
            <div class="row px-5 ">
                <div class="col-xl-7">
                    <div class="py-2">
                        <input type="text" class="form-control py-3 rounded-3 " placeholder="Your name" id="name">
                    </div>
                    <div class="py-3">
                        <input type="text" class="form-control py-3 rounded " placeholder="Your Email" id="email">
                    </div>
                    <textarea name="" id="msg" cols="74" rows="5" placeholder="Your Message"
                        class="rounded py-3 col-12"></textarea>

                    <input type="submit"
                        class=" mt-3 text-center col-12 btn border border-warning rounded bg-white addtocart  py-3"
                        name="loginbtn" id="contactbtn" value="Submit">
                    <!-- <a href="" class="btn border border-warning rounded bg-white addtocart w-100 my-4 py-3">
                        Submit</a> -->
                </div>
