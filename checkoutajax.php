...
include ("config.php");
error_reporting(0);
if (isset($_SESSION['mobilenum']) && ($_SESSION['login_type'])) {
          ...
          <div class='row'>
              <div class='col-xl-7 col-lg-7 col-sm-12'>
                  ...
                  <div>
                      ...
                      <label for='cname' class='h-color py-2 mb-2 d-none'>Session*</label>
                      <input type='text' name='cname' id='cname' class='form-control d-none' value=' $phone' required='required'>
                      ...
                      <input type='text' name='town' id='town' class='form-control' value=' $town' required='required'>
                  ...
                  <input type='submit' class=' btn border border-warning rounded  addtocart  my-4 col-12 px-4 py-3'
            ...
            <div class='col-xl-5  col-lg-5 col-sm-12'>
                <div class='container py-5'>
                    <div class='row'>
                        ...
                        <div class='col-2 h-color'>Rate</div>
...
if (mysqli_num_rows($cart) > 0) {
    ...
    while ($result = mysqli_fetch_assoc($cart)) {
        ...
        $totalprice = $result['rate'];
        $total = $result['totalprice'];
        $sum += number_format($totalprice * $quant);
        ...
        $output .= "  <!-- First Item start -->
                    <div class='row border-bottom py-4'>
                        ...
                        <div class='col-2 h-color'>$totalprice</div>
                        <div class='col-2 h-color'>$quant</div>
...
$output .=
    "            
                    ...
                    <div class='row py-5 border-bottom'>
                        ...
                        <div class='col-3 border-bottom border-top py-2 h-color'>$sum.0</div>
                    </div>
                    <!-- Subtotal end -->
