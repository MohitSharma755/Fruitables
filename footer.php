            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="position-relative mx-auto">
                        <input type="text" class="form-control border-0 w-100 py-3 px-3 rounded-pill"
                ...
                <div class="col-xl-3 col-sm-12 text-end">
                    <a href="" class="ms-2">
                         <svg xmlns="http://www.w3.org/2000/svg" class="radius text-warning p-3 col-sm-12"
                            width="30" height="50" viewBox="0 0 432 384">
